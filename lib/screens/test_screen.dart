...
class TestScreen extends StatefulWidget {
  final int number0fQuestions;

  TestScreen({required this.number0fQuestions});
...
class _TestScreenState extends State<TestScreen> {
  ...
  void initState() {
    ...
    numberOfCorrect = 0;
    correctRate = 0;
    numberOfRemaining = widget.number0fQuestions;
  ...
  answerCheck() {
    ...
    correctRate = (numberOfCorrect / (widget.number0fQuestions - numberOfRemaining) * 100).toInt();
